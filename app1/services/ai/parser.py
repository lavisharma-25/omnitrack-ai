...
from app1.config import gemini_api_key, gemini_model_flash
from app1.schemas.action import ParsedAction
...
class GeminiIntentParser(IntentParser):
    def __init__(self, api_key: str | None = None, model: str = gemini_model_flash):
